...
class FeedbackWidget extends StatefulWidget {
  ...
  @override
  State<FeedbackWidget> createState() =>
      _FeedbackState(username: username, isteach: isteach, student: student);
}
...
class _FeedbackState extends State<FeedbackWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        drawer:
            MyDrawer(isteach: isteach, student: student, username: username),
        body: Column(
          children: [
            Header(
